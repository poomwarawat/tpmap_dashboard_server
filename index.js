    ...
    routes: [
      {
        aliases: {
          ...
          "GET /marker/tambol/:id": "tambol_marker.getAllMarker",
          "GET /marker/village/:id": "village_marker.getAllMarker",
        },
      },
    ],
  },
...
const Tambol_Marker = require("./service/Marker/Amphur");
const Village_Marker = require("./service/Marker/Tambo");
